...
<div style="margin-top:0.8rem; display:inline-block; padding:0.45rem 1rem; background:#fffbeb; border:1.5px dashed #d97706; border-radius:8px; font-size:0.85rem;">
  <span style="color:#d97706; font-weight:700;">📌 補充</span><span style="color:#78350f;"> — upstream sync / push -f / GitHub Pages / 純 Git 協作</span>
</div>
...
<div style="border: 2px dashed #d97706; border-radius: 16px; padding: 1.2rem 2.5rem; display: inline-block; background: #fffbeb;">
  ...
  <div style="color: #92400e; font-size: 1.8rem; font-weight: 900;">進階 GitHub 操作</div>
  <div style="color: #b45309; font-size: 0.85rem; margin-top: 0.4rem;">upstream / push -f / GitHub Pages / 純 Git — 依需要自行閱讀</div>
</div>
