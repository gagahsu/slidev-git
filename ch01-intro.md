...
- **1. 版本控制概念** — 為什麼需要版本控制？VCS 的演進歷史
- **2. Git 是什麼** — 分散式架構、核心設計哲學
- **3. Git 三大區域** — Working Directory / Staging Area / Repository
- **4. Git 物件模型** — Blob、Tree、Commit、Tag
- **5. 安裝 Git** — Windows / macOS / Linux 安裝方式
- **6. 初始設定** — `git config` 使用者資訊、編輯器、換行符號
- **7. 取得說明** — `git help`、man page
